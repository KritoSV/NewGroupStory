...
* **Как удалить все локальные файлы и директории, которые не отслеживает Git, из вашей текущей копии?**
...
* **Как вернуться к любому коммиту**
...
## *Основные ошибки при работе с Markdown*

Если следовать синтаксису Markdown, то все у вас должно получиться. Git всегда вам укажет на ваши ошибки.
