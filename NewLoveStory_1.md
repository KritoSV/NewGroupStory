...
Оглавление:
1. [Подготовительные действия перед началом работы с Git в Visual Studio Code.](#title1)

2. Работа с **_MarkDown_** Тонкости и плюсы. --- **__Shmid__**
3. [Начало работы с **Git** в *Visual Studio Code* и немного магии.](#title3) 
...
![вот здесь можно было посмотреть))](pwrshellBash.jpg)
